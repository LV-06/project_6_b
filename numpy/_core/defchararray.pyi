...
class chararray(ndarray[_ShapeType_co, _CharDType_co]):
    ...
    def __mul__(self, other: i_co) -> chararray[Any, _CharDType_co]: ...
    def __rmul__(self, other: i_co) -> chararray[Any, _CharDType_co]: ...
    def __mod__(self, i: Any) -> chararray[Any, _CharDType_co]: ...
    ...
    def zfill(self, width: _ArrayLikeInt_co) -> chararray[Any, _CharDType_co]: ...
